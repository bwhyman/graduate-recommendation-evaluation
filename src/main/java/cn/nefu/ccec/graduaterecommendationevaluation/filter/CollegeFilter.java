...
public class CollegeFilter implements WebFilter {
    PathPattern includes = new PathPatternParser().parse("/api/college/**");
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        if (includes.matches(request.getPath().pathWithinApplication())) {
            ...
            if (User.COLLAGE_ADMIN.equals(role) || User.CATEGORY_ADMIN.equals(role)) {
